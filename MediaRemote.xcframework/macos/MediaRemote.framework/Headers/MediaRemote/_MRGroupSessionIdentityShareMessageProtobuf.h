...
//
#ifndef _MRGroupSessionIdentityShareMessageProtobuf_h
#define _MRGroupSessionIdentityShareMessageProtobuf_h
@import Foundation;
...
#endif /* _MRGroupSessionIdentityShareMessageProtobuf_h */
