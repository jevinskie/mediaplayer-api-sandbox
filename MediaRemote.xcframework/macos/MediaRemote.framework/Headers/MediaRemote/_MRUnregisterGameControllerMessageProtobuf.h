...
//
#ifndef _MRUnregisterGameControllerMessageProtobuf_h
#define _MRUnregisterGameControllerMessageProtobuf_h
@import Foundation;
...
#endif /* _MRUnregisterGameControllerMessageProtobuf_h */
