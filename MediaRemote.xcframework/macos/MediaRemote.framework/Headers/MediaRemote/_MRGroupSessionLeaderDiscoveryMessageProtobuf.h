...
//
#ifndef _MRGroupSessionLeaderDiscoveryMessageProtobuf_h
#define _MRGroupSessionLeaderDiscoveryMessageProtobuf_h
@import Foundation;
...
#endif /* _MRGroupSessionLeaderDiscoveryMessageProtobuf_h */
