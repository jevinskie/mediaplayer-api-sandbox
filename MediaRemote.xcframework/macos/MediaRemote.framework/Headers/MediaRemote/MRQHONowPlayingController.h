...
- (void)_downloadContentItemArtwork:(id)artwork
                              queue:(id)queue
                         completion:(id /* block */)completion;
...
- (void)_notifyDelegateOfPlaybackStateChangeFromOldState:(unsigned int)state
                                              toNewState:(unsigned int)state;
- (void)_notifyDelegateOfSupportedCommandsChangeFromOldCommands:(id)commands
                                                  toNewCommands:(id)commands;
...
- (void)_onQueue_requestAndUpdateArtworkForContentItems:(id)items
                                          forPlayerPath:(id)path
                                             withReason:(id)reason;
- (void)_onQueue_requestPlaybackQueueForPlayerPath:(id)path
