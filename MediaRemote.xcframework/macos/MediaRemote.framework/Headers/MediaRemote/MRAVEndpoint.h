...
+ (void)_notifyVolumeCapabilitiesDidChange:(unsigned int)change
...
+ (void)connectToEndpointContainingOutputDeviceUID:(id)uid
                                           options:(unsigned int)options
                                           details:(id)details
                                        completion:(id /* block */)completion;
+ (void)createEndpointWithOutputDeviceUIDs:(id)uids
...
+ (void)createEndpointWithOutputDeviceUIDs:(id)uids
                                     queue:(id)queue
                                completion:(id /* block */)completion;
+ (void)directEndpointForOutputDeviceUIDs:(id)uids
                                    queue:(id)queue
                               completion:(id /* block */)completion;
+ (void)hostedEndpointForOutputDeviceUIDs:(id)uids
                                    queue:(id)queue
                               completion:(id /* block */)completion;
...
- (void)adjustOutputDeviceVolume:(long long)volume
                    outputDevice:(id)device
                           queue:(id)queue
                      completion:(id /* block */)completion;
- (void)adjustVolume:(long long)volume
             details:(id)details
               queue:(id)queue
          completion:(id /* block */)completion;
...
- (_Bool)isVolumeMuted;
- (void)migrateToEndpoint:(id)endpoint
                  request:(id)request
                    queue:(id)queue
               completion:(id /* block */)completion;
- (void)migrateToEndpointOrModifyTopology:(id)topology
                         migrationRequest:(id)request
              topologyModificationRequest:(id)request
                           withReplyQueue:(id)queue
                               completion:(id /* block */)completion;
- (void)migrateToOrAddOutputDevices:(id)devices
                          initiator:(id)initiator
                     withReplyQueue:(id)queue
                         completion:(id /* block */)completion;
- (void)migrateToOrSetOutputDevices:(id)devices
                          initiator:(id)initiator
                     withReplyQueue:(id)queue
                         completion:(id /* block */)completion;
- (void)migrateToOutputDevice:(id)device
                      request:(id)request
                    initiator:(id)initiator
                        queue:(id)queue
                   completion:(id /* block */)completion;
- (void)migrateToOutputDevices:(id)devices
                       request:(id)request
                     initiator:(id)initiator
                         queue:(id)queue
                    completion:(id /* block */)completion;
...
- (void)performMigrationToEndpoint:(id)endpoint
                           request:(id)request
                             queue:(id)queue
                        completion:(id /* block */)completion;
- (void)performMigrationToOutputDevices:(id)devices
                                request:(id)request
                              initiator:(id)initiator
                                  queue:(id)queue
                             completion:(id /* block */)completion;
...
- (void)setListeningMode:(id)mode
         outputDeviceUID:(id)uid
                   queue:(id)queue
              completion:(id /* block */)completion;
- (void)setOutputDeviceIsMuted:(_Bool)muted
                  outputDevice:(id)device
                         queue:(id)queue
                    completion:(id /* block */)completion;
...
- (void)willStartingPlaybackToOutputDeviceInterruptPlayback:(id)playback
                                                   duration:(double)duration
                                                      queue:(id)queue
                                                 completion:(id /* block */)completion;
- (void)willStartingPlaybackToOutputDevicesInterruptPlayback:(id)playback
                                  originatingOutputDeviceUID:(id)uid
                                                    duration:(double)duration
                                                       queue:(id)queue
                                                  completion:(id /* block */)completion;
