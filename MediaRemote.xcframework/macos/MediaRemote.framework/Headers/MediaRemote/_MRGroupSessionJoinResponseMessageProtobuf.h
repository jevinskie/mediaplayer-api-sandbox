...
//
#ifndef _MRGroupSessionJoinResponseMessageProtobuf_h
#define _MRGroupSessionJoinResponseMessageProtobuf_h
@import Foundation;
...
#endif /* _MRGroupSessionJoinResponseMessageProtobuf_h */
